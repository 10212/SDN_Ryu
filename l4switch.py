        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                if protocol == in_proto.IPPROTO_ICMP:
                    ...
                    self.logger.info("%s packet from %s to %s", protocol, srcip, dstip)
                #  if TCP Protocol
                    ...
                    self.logger.info("%s packet from %s to %s,src_port: %s,dst_port: %s", protocol, srcip, dstip,t.src_port,t.dst_port)
                #  If UDP Protocol 
